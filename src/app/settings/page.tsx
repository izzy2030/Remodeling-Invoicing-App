    ...
    <Suspense fallback={
      <div className="flex items-center justify-center py-32">
        <div className="text-center space-y-4">
          <div className="w-12 h-12 bg-gradient-to-br from-primary to-accent rounded-md mx-auto flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="max-w-4xl mx-auto px-6 h-12 flex items-center">
        {message && (
          <div className={`w-full py-2.5 px-4 rounded-md text-xs font-bold animate-in fade-in slide-in-from-top-2 border ${message.includes('Error')
      ...
      <main className="max-w-4xl mx-auto px-6 py-4 space-y-12">
        ...
        {onboarding && (
          <div className="relative rounded-lg overflow-hidden animate-fade-up">
            ...
            <div className="relative p-10 flex flex-col md:flex-row items-center gap-8">
              <div className="w-16 h-16 bg-white/15 backdrop-blur-xl rounded-md flex items-center justify-center border border-white/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <aside className="lg:col-span-4 space-y-4">
            <nav className="space-y-1">
              {[
                ...
                <button
                  ...
                  className={`
                      w-full flex items-center gap-3 px-4 py-3 rounded-md font-bold text-sm
                      ${activeTab === tab.id
            ...
            <div className="pt-6">
              <Button variant="ghost" className="w-full justify-start text-destructive hover:bg-destructive/10 hover:text-destructive h-12 rounded-md font-bold" onClick={handleSignOut}>
                ...
                <div className="card-premium p-8 space-y-10">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="bg-secondary px-3 py-1.5 rounded-md border border-border flex items-center gap-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div
                      ...
                      className="border-2 border-dashed border-border rounded-lg p-10 flex flex-col items-center justify-center gap-4 bg-secondary/20 hover:bg-card hover:border-primary/30 cursor-pointer group relative overflow-hidden"
                    >
                      <input
                        type="file"
                        ref={fileInputRef}
                      ...
                      {settings.logo_url ? (
                        <>
                          ...
                          <div className="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center z-20 backdrop-blur-[2px]">
                            <div className="bg-white/90 px-5 py-2.5 rounded-md flex items-center gap-2">
                ...
                <div className="card-premium overflow-hidden divide-y divide-border">
                  <div className="p-8 flex items-center justify-between">
                    <div className="flex items-center gap-6">
                      <Avatar className="h-20 w-20 rounded-lg border-2 border-secondary">
                    ...
                    <Button variant="secondary" size="sm" className="rounded-md font-bold">Edit Profile</Button>
                  </div>

                  <div className="p-8 flex items-center justify-between hover:bg-secondary/20 transition-colors group cursor-pointer">
                    <div className="flex items-center gap-4">
                      <div className="w-11 h-11 bg-amber-500/10 rounded-md flex items-center justify-center">
              ...
              <section className="space-y-8 animate-fade-up">
                ...
                <div className="space-y-4">
                  <div className="card-premium p-6 flex items-center justify-between hover:bg-secondary/20 transition-colors group cursor-pointer">
                    <div className="flex items-center gap-4">
                      <div className="w-11 h-11 bg-violet-500/10 rounded-md flex items-center justify-center">
                  ...
                  <div className="card-premium p-6 flex items-center justify-between hover:bg-secondary/20 transition-colors group cursor-pointer">
                    <div className="flex items-center gap-4">
                      <div className="w-11 h-11 bg-foreground rounded-md flex items-center justify-center">
